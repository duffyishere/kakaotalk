            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: const [
                      Text("채널", style: TextStyle(color: Colors.grey, fontWeight: FontWeight.w100, fontSize: 12),),
                    ],
                  ),
                  SizedBox(height: 5,),
                  Column(
                  ...
                  Row(
                    children: const [
                      Text("친구 121", style: TextStyle(color: Colors.grey, fontWeight: FontWeight.w200, fontSize: 12),),
                    ],
                  ),
                  SizedBox(height: 5,),
                  Column(
                      ...
                      Row(
                        children: [
                          ...
                          Container(
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(18.0),
                              child: Image.asset('assets/profile1.jpg', width: 45, height: 45, ),
                            ),
                          ),
                          SizedBox(width: 15,),
                          Text("강예준", style: TextStyle(color: Colors.black, fontWeight: FontWeight.w500, fontSize: 15.5),),
                        ],
                      ),
                      SizedBox(height: 10,),
                      Row(
                        children: [
                          ...
                          Container(
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(18.0),
                              child: Image.asset('assets/empty_profile_small.jpg', width: 45, height: 45, ),
                            ),
                          ),
                          SizedBox(width: 15,),
                          Text("강래연", style: TextStyle(color: Colors.black, fontWeight: FontWeight.w500, fontSize: 15.5),),
                        ],
                      ),
                    ],
                  )
